...
mfishnet <- Fishnet(
  ...
  amat      = TaxonomicImputer('amat',c(log,exp)),
...
# fishbase
data.fb <- model.frame('m~species+genus+family+order+class+amat',fb,na.action=na.pass)
data.fb <- data.fb[!is.na(data.fb$m),]

res <- cvfishnet(mfishnet,data.fb,byspecies=T)
saver(mfishnet,res,name='fb/mfishnet1_res')
...
pdfr(fig,width=10,name='fb/mfishnet1_prediction')

# gislason
data.gs <- model.frame('m~species+genus+family+order+class+amat',gs,na.action=na.pass)
data.gs <- data.gs[!is.na(data.gs$m),]

res <- cvfishnet(mfishnet,data.gs,byspecies=T)
saver(mfishnet,res,name='gs/mfishnet1_res')
...
pdfr(fig,width=10,name='gs/mfishnet1_prediction')
...
mfishnet <- Fishnet(
  ...
  k         = TaxonomicImputer('k',c(log,exp)),
...
# fishbase
data.fb <- model.frame('m~species+genus+family+order+class+k',fb,na.action=na.pass)
data.fb <- data.fb[!is.na(data.fb$m),]

res <- cvfishnet(mfishnet,data.fb,byspecies=T)
saver(mfishnet,res,name='fb/mfishnet2_res')
...
pdfr(fig,width=10,name='fb/mfishnet2_prediction')

# gislason
data.gs <- model.frame('m~species+genus+family+order+class+k',gs,na.action=na.pass)
data.gs <- data.gs[!is.na(data.gs$m),]

res <- cvfishnet(mfishnet,data.gs,byspecies=T)
saver(mfishnet,res,name='gs/mfishnet2_res')
...
pdfr(fig,width=10,name='gs/mfishnet2_prediction')
...
# fishbase
data.fb <- model.frame('m~species+genus+family+order+class+amax',fb,na.action=na.pass)
data.fb <- data.fb[!is.na(data.fb$m),]

res <- cvfishnet(mfishnet,data.fb,byspecies=T)
saver(mfishnet,res,name='fb/mfishnet3_res')
...
pdfr(fig,width=10,name='fb/mfishnet3_prediction')

# gislason
data.gs <- model.frame('m~species+genus+family+order+class+amax',gs,na.action=na.pass)
data.gs <- data.gs[!is.na(data.gs$m),]

res <- cvfishnet(mfishnet,data.gs,byspecies=T)
saver(mfishnet,res,name='gs/mfishnet3_res')
...
pdfr(fig,width=10,name='gs/mfishnet3_prediction')
...
res <- cvfishnet(mfishnet,data.fb,byspecies=T)
saver(mfishnet,res,name='fb/mfishnet4_res')
...
pdfr(fig,width=10,name='fb/mfishnet4_prediction')
...
res <- cvfishnet(mfishnet,data.gs,byspecies=T)
saver(mfishnet,res,name='gs/mfishnet4_res')
...
pdfr(fig,width=10,name='gs/mfishnet4_prediction')
...
mfishnet <- Fishnet(
  ...
  linf      = TaxonomicImputer('linf',c(log,exp)),
  k         = TaxonomicImputer('k',c(log,exp)),
...
# fishbase
data.fb <- model.frame('m~species+genus+family+order+class+lmat+linf+k',fb,na.action=na.pass)
data.fb <- data.fb[!is.na(data.fb$m),]

res <- cvfishnet(mfishnet,data.fb,byspecies=T)
saver(mfishnet,res,name='fb/mfishnet5_res')
...
pdfr(fig,width=10,name='fb/mfishnet5_prediction')

# gislason
data.gs <- model.frame('m~species+genus+family+order+class+lmat+linf+k',gs,na.action=na.pass)
data.gs <- data.gs[!is.na(data.gs$m),]

res <- cvfishnet(mfishnet,data.gs,byspecies=T)
saver(mfishnet,res,name='gs/mfishnet5_res')
...
pdfr(fig,width=10,name='gs/mfishnet5_prediction')
...
# fishbase
data.fb <- model.frame('m~species+genus+family+order+class+temp+linf+k',fb,na.action=na.pass)
data.fb <- data.fb[!is.na(data.fb$m),]

res <- cvfishnet(mfishnet,data.fb,byspecies=T)
saver(mfishnet,res,name='fb/mfishnet6_res')
...
pdfr(fig,width=10,name='fb/mfishnet6_prediction')

# gislason
data.gs <- model.frame('m~species+genus+family+order+class+temp+linf+k',gs,na.action=na.pass)
data.gs <- data.gs[!is.na(data.gs$m),]

res <- cvfishnet(mfishnet,data.gs,byspecies=T)
saver(mfishnet,res,name='gs/mfishnet6_res')
...
pdfr(fig,width=10,name='gs/mfishnet6_prediction')
...
data.fb <- model.frame('m~species+genus+family+order+class+temp+linf+k+amax',fb,na.action=na.pass)
data.fb <- data.fb[!is.na(data.fb$m),]

res <- cvfishnet(mfishnet,data.fb,byspecies=T)
saver(mfishnet,res,name='fb/mfishnet7a_res')
...
pdfr(fig,width=10,name='fb/mfishnet7a_prediction')
...
data.gs <- model.frame('m~species+genus+family+order+class+linf+k+amax',gs,na.action=na.pass)
data.gs <- data.gs[!is.na(data.gs$m),]

res <- cvfishnet(mfishnet,data.gs,byspecies=T)
saver(mfishnet,res,name='gs/mfishnet7b_res')
...
pdfr(fig,width=10,name='gs/mfishnet7b_prediction')
...
write.csv(dfr,file='C:/PROJECTS/FISHNETS/res/cvfishnet.csv')
